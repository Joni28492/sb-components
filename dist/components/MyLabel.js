...
var MyLabel = function (_a) {
    ...
    (0, jsx_runtime_1.jsx)("span", __assign({ style: { color: fontColor, backgroundColor: backgroundColor }, className: "label ".concat(size, " text-").concat(color) }, { children: (allCaps) ? label.toUpperCase() : label })));
};
